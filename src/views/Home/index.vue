...
import KnowledgeList from '@/components/home/consult/KnowledgeList.vue'
import CpIcon from '@/components/VantCpt/cp-icon.vue'
import FollowDoctor from '@/components/home/consult/FollowDoctor.vue'
// 组件名
defineComponent({
  name: 'HomeIndex'
})
...
<template>
  <div class="home-page">
    ...
    <div class="home-banner">
      <van-swipe indicator-color="#fff" autoplay="3000" duration="1000" lazy-render>
        <van-swipe-item>
  ...
  <van-tabs shrink sticky v-model:active="active" @change="onChange">
    <van-tab title="关注">
      <follow-doctor />
