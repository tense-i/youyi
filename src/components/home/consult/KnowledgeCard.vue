...
import type { Knowledge } from '@/types/consult/Knowledge'
...
const followDoctorHandler = async(item: Knowledge) => {
  try {
    loading.value = true
    debugger
...
<template>
  <div class="knowledge-card van-hairline--bottom">
    <div class="head">
      ...
      <van-button class="btn" size="small" round :loading="loading" @click="followDoctorHandler(item)">
